Note: Get nerd-sniped for the love of god. I was supposed to be doing something productive when I asked myself, completely unprompted: "GPT-2 was trained entirely on English... so does it actually *know* what 'gaana' means?" Two days later, I had HTML visualizations, a GitHub repo, and no regrets. If you work on multilingual interpretability, I'd genuinely love to [chat](mailto:ysrivastava82@gmail.com).
